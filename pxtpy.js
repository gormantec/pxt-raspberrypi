...
(function (pxt) {
    ...
    (function (py) {
        ...
        function py2ts(opts) {
            ...
            var pyFilesSet = pxt.U.toDictionary(pyFiles, function (p) { return p; });
            // find .ts files that are copies of / shadowed by the .py files
            var tsShadowFiles = opts.sourceFiles
                .filter(function (fn) { return pxt.U.endsWith(fn, ".ts"); })
                .filter(function (fn) { return fn.substr(0, fn.length - ".ts".length) in pyFilesSet; });
...
(function (pxt) {
    ...
    (function (py) {
        ...
        function tsToPy(prog, filename) {
            ...
            var _a = ts.pxtc.decompiler.buildRenameMap(prog, file), renameMap = _a[0], globalNames = _a[1];
            var symbols = pxtc.getApiInfo(prog);
            // ts->py 
            ...
            function tryGetPyName(exp) {
                ...
                var sym = symbols.byQName[tsExp];
                var isFromUserPackage = sym && sym.pkg == null;
